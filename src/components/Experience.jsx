...
const experiences = [
  {
    ...
    color: "#4F46E5",
    points: [
      "Built scalable web applications using React.js, Spring Boot, and MySQL with a focus on performance and maintainability.",
      "Developed REST APIs and backend services using Java and Spring Boot for secure and efficient data processing.",
      "Created responsive and user-friendly interfaces using React.js, JavaScript, HTML, and CSS following modern UI/UX principles.",
      "Enhanced accessibility, responsiveness, and user experience for community-focused platforms including Yuva-Mitra and Anand Sadhana Mission.",
    ],
    tags: ["React", "Spring Boot", "MySQL","PostgreSQL", "Tailwind CSS","REST API"],
  },
  {
    id: 2,
    ...
    color: "#10B981",
    points: [
      "Built reusable React.js components to create scalable and maintainable web applications.",
      "Integrated frontend applications with Spring Boot REST APIs, ensuring seamless data flow, efficient communication, and reliable user experiences across web platforms.",
      "Followed TDD practices to enhance software quality, reliability, and overall application performance.",
    ],
  ...
  },
  {
    ...
    color: "#F97316",
    points: [
         "Built modular and reusable UI components using HTML, CSS, and JavaScript for scalable web applications.",
         "Managed code repositories and version control workflows using Git and collaborative development practices.",
         "Worked effectively in a cross-functional team environment to deliver projects through structured planning and coordination."
    ],
